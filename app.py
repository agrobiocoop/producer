...
# Tab 4: Προβολή/Επεξεργασία Εγγραφών
...
# Τα υπόλοιπα tabs παραμένουν όπως πριν...
# (Αναφορές, Διαχείριση, Διαχείριση Χρηστών, Αποθηκευτικοί Χώροι)

# ... (ο κώδικας για τα υπόλοιπα tabs παραμένει ίδιος)
